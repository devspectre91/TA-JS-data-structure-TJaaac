...
Yes, because all keys of an objects are strings which are different from keywords.
    // 12. Delete the `isAdult` property from the object `students`. Also, print the object before or after deleting the property
    students;
//{42: "The answer to the meaning of life", studentName: "Devanshu", batch: 16, isAdult: true}
delete students.isAdult;
//   {42: "The answer to the meaning of life", studentName: "Devanshu", batch: 16}
