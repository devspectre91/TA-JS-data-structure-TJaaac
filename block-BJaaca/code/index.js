...
character['greet'] = () => alert(`I am ${character.characterName} amd my title is ${character.title}`);
...
(age > 18) ? character.isAdult = 'true' : character.isAdult = 'false';
...
character.changeIsAdult = () => character.isAdult = !(character.isAdult);
