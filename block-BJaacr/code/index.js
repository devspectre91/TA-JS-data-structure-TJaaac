...
let gotHouses = {}
for (house of got.houses) {
  gotHouses[house.name] = house.people.length;
}
...
for (people of allDescription) {
  console.log(people);

}
console.log(allDescription.length);
// 20. Only log the description whose length is more than 30. (use .length property on string to get the length)
for (people of allDescription) {
